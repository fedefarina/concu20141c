...
QT_MOC_LITERAL(3, 27, 10)
    ...
    "WorkerThread\0finishSignal\0\0onFinished\0"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::finishSignal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void WorkerThread::finishSignal()
{
